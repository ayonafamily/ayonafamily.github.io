const autor = () => {
    let fecha = new Date();
    const author = "<a href='https://jorgeayona.com' title='Jorge Ayona'><em>Jorge Ayona</em></a>";
    const whatsapp="<a class='btn btn-outline-success m-2' href = 'https://api.whatsapp.com/send?phone=51995121512' target='_blank'><i class='fa fa-whatsapp' aria-hidden='false'></i>Whatsapp</a>";    
